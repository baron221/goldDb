...
<div>
    <el-row :gutter="20">
      <el-col :span="24">
        <el-form-item label="제품 사이즈" prop="sizes">
          <el-select
    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="12">
        <el-form-item label="제품크기" prop="productSize">
          <el-input v-model="localTemp.productSize" />
        </el-form-item>
      </el-col>
      <el-col :xs="24" :sm="12">
        <el-form-item label="기본감량" prop="basicLoss">
      ...
      <el-col :span="24">
        <el-card shadow="never" style="border-radius: 2px; border: 1px solid #eae6df;">
          <template #header>
            <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 0.9375rem;">
              ...
              <div style="display: flex; align-items: center; gap: 0.5rem; background-color: #fbfaf7; border: 1px solid #e2ded8; padding: 0.25rem 0.625rem; border-radius: 2px;">
                <span style="font-size: 0.8875rem; font-weight: 600; color: #8a6d3b;">⚖️ 중량 일괄 환산기</span>
                <el-select
                ...
                <el-input-number
                  ...
                  style="width: 110px;"
                />
                <span style="font-size: 0.8875rem; color: #606266;">g 기준</span>
          ...
          <base-table :data="localCombinationGridData" size="small" style="width: 100%;">
            ...
            <el-table-column label="중량 (g)" align="center">
              <template #default="{ row }">
                <el-input-number
                  v-model="row.weight"
                  :precision="2"
