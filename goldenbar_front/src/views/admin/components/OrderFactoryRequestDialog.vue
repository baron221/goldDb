...
const initializeForm = () => {
  ...
  props.order.orderItems.forEach((item: any) => {
    ...
    items.push({
      ...
      approvedWeight: item.approvedWeight || item.orderWeight || 0,
      approvedMemo: item.approvedMemo || '',
      actualWeight: item.actualWeight || item.approvedWeight || item.orderWeight || 0,
      requestedWeight: item.requestedWeight || item.approvedWeight || item.orderWeight || 0,
    ...
    if (item.children && item.children.length > 0) {
      item.children.forEach((child: any) => {
        ...
        items.push({
          ...
          approvedWeight: child.approvedWeight || child.orderWeight || 0,
          approvedMemo: child.approvedMemo || '',
          actualWeight: child.actualWeight || child.approvedWeight || child.orderWeight || 0,
          requestedWeight: child.requestedWeight || child.approvedWeight || child.orderWeight || 0,
