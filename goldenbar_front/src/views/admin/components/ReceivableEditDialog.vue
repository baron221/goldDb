<template>
<base-popup v-model="visible" title="입금 내역 수정" width="480px" @close="handleClose">
...
import { updateReceivable } from '@/api/receivable';
...
const handleSubmit = async () => {
  ...
  try {
    await updateReceivable(props.record.id, {
